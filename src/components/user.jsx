      ...
      <div className="w-full h-[43rem] flex justify-end">
        <div className="w-1/4 h-full bg-[#020203] rounded-br-2xl flex flex-col items-center justify-between p-4">
          <div className="w-10/12 h-1/3">
            ...
            <Button className="w-full h-1/5">workspace</Button>
            <Button className="w-full h-1/5">projects</Button>
            <Button className="w-full h-1/5">learning</Button>
            <Button className="w-full h-1/5">chatbot</Button>
          </div>
